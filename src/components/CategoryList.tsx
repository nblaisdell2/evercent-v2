...
function CategoryList({
  ...
  const groupRow = (grp: CategoryListGroup) => {
    return (
      <div
        key={grp.groupName}
        className="flex justify-between w-full font-bold text-right hover:bg-gray-300 hover:cursor-pointer hover:rounded-md"
  ...
  const categoryRow = (category: CategoryListItem) => {
    return (
      <div
        key={category.name}
        className="flex justify-between w-full font-normal text-right hover:bg-gray-200 hover:cursor-pointer hover:rounded-md"
        onClick={() => {
  ...
  return (
    <div className="flex-grow mt-4">
      ...
      <div className="flex">
        <Card className="h-full flex-grow mr-2 p-1">
          <div className="flex justify-between w-full font-bold text-right whitespace-nowrap">
            <div className="w-[2%]"></div>
            ...
            <div className="w-[14%]">Adjusted Amt.</div>
            <div className="w-[14%]">Extra</div>
            <div className="w-[14%]">Adj. + Extra</div>
